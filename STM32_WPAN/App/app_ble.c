...
uint8_t a_AdvData[6] =
{
  5, AD_TYPE_COMPLETE_LOCAL_NAME, 't', 'V', 'N', 'S',  /* Complete name */
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      if (p_disconnection_complete_event->Connection_Handle == BleApplicationContext.BleApplicationContext_legacy.connectionHandle)
      {
        ...
        // Погасим красный светодиод, если соединение было разорвано
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          // Включаем красный светодиод, когда соединение окончательно установлено между устройствами
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_HAL_END_OF_RADIO_ACTIVITY_VSEVT_CODE:
          /* USER CODE BEGIN RADIO_ACTIVITY_EVENT*/
        	// При любом радиособытии мигаем зеленым светодиодом
